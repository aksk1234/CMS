    ...
    function handleClick(contentId) {
        ...
        switch (contentId) {
            ...
            case 'Guideline':
                ...
                <section>
                    <h2>Guideline</h2>
                    <p>일본어와 한국어 외의 대응이 어렵습니다.<br><br></p>
                    ...
                    <p>→키 비주얼 일러스트, 스탠딩 일러스트, 아이콘용 일러스트, SD 일러스트, MV 일러스트, 굿즈 제작용 일러스트 등 다양하게 접수중입니다. <br><br></p>

                    <b>::기본적인 의뢰 진행 과정::</b><br>

                    <p>신청서 확인 → 청구서 작성 후 청구 → 입금 확인 → 러프 제출 → 수정 확인 후 완성 → 납품 전 최종 수정 확인 → 납품 완료</p>
                </section>
                `;
                break;
            case 'Contact':
...
・예외적인 상황을 제외한 모든 상황에서 환불이 불가합니다.<br>
・신청서에 표기 되어있지 않은 부분의 수정요청(큰 첨삭이 필요한 경우)은 거절 될 수 있습니다.<br>
・허가 되지 않은 상업적 이용을 금지합니다.<br>
・AI 학습을 금지합니다.<br>
...
・결제는 계좌 입금으로만 가능합니다.<br>
・트러블 방지를 위해 전부 선입금 후 진행 됩니다.<br>
・작업 기간은 기본 6주입니다.<br>
・상시로 접수중일 경우 메일 확인 후 천천히 연락드립니다. (다만 2주 내로 회신이 없을 경우 작성해주신 메일의 오류로 판단 부탁드립니다.)<br>

...
<br>
            ...
            case 'Commission':
                ...
                <h2>Commission</h2>
                    ...
                    <b>::Commission問い合わせテンプレート::</b><br>
<U><font color="red">*</font> 表示の項目は必須項目です。</U><br>
...
・背景透過の有無:<br>
・参考イラスト (私のイラストの中で一番ご希望の画風、デフォルメに近いイラストがあれば、参考までに添付してください。):<br>
・その他のご要望 :<br><br><br>
...
・例外的な状況を除き、すべての状況での払い戻しはできません。<br>
・申請書に記載されていない部分の修正依頼はお断りする場合があります。<br>
・許可されていない商用利用を禁止します。<br>
・AI学習を禁止します。<br>
...
・記載されている金額は最低金額基準です。<br>
・申請書の内容、納期など予算は変動する場合があります。<br>
・支払いはpaypalで対応しています。(手数料あり)<br>
・トラブル防止のために全額先払いをお願いしております。<br>
・作業期間は基本6週間となります。<br>
・常時受付中の場合、メールの確認後、ゆっくりご連絡いたします。(ただし、2週間以内に返信がない場合は、作成いただいたメールにエラーがあったものと見なしてください。)<br>
                </section>
                `;
                break;
            default:
